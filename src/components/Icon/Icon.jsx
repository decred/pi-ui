...
const icons = (type, backgroundColor, iconColor) => {
  return {
    ...
    chart: (
      <>
        <path
          d="M12.6387 12.9611L17.1369 17.4592C18.2425 16.2098 18.8984 14.6264 19.0002 12.9611H12.6387Z"
          fill={backgroundColor}
        />
        <path
          d="M11.9761 12.024H19.0001C18.8859 10.1986 18.1091 8.47762 16.8158 7.1843C15.5225 5.89098 13.8015 5.11427 11.9761 5V12.024Z"
          fill={backgroundColor}
        />
        <path
          d="M11.039 12.6866V5C7.11106 5.24192 4 8.50364 4 12.4925C3.99993 13.9375 4.41686 15.3517 5.20076 16.5656C5.98465 17.7794 7.10219 18.7412 8.41924 19.3355C9.73629 19.9299 11.1969 20.1315 12.6257 19.9162C14.0545 19.7009 15.3908 19.0778 16.4742 18.1217L11.039 12.6866Z"
          fill={iconColor}
        />
      </>
    ),
